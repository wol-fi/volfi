...
int main(){
 ...
 std::uniform_real_distribution<double> ud(0.001,0.01), uv(0.01,2.0);
 ...
 mae/=n;
 std::printf("random_low_delta_seed %llu\n",seed);
 std::printf("cases %d\n",n);
 std::printf("delta_distribution uniform_0.001_0.01\n");
 ...
 std::printf("nan_count %d\n",nan);
 return (mxe<1e-14 && ngt==0 && nan==0) ? 0 : 1;
}
