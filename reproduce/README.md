...
| `accuracy/bracket_cert.cpp` | Arb | `make certify`, the pointwise residual-bracket certificate of the paper's Appendix D: takes the returned doubles exactly and proves `C(h,(1-eta)v) < c < C(h,(1+eta)v)` in ball arithmetic, 42,408 of 42,408 points certified at 1e-15 (`results/v0.3.1/bracket_cert_2026-09-21.txt`) |
