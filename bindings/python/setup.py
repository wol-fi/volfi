...
# The v0.2.3 engine is header-only C++17. -ffp-contract=off is what makes the scalar and SIMD
...
setup(
    name="volfi",
    version="0.2.3",
    description="Python bindings for volfi v0.2.3 (routed machine-precision Black-Scholes IV inverter)",
    packages=["volfi"],
    package_dir={"": "src_py"},
