...
Minimal R binding for the volfi research reference implementation.
...
Functions named `volfi_w` return total implied variance. Functions named `volfi_iv` return implied volatility.
