...
volfi_w_book <- function(h, c) .Call("_volfiR_volfi_w_book", as.numeric(h), as.numeric(c), PACKAGE = "volfiR")
volfi_iv_book <- function(h, c, t) .Call("_volfiR_volfi_iv_book", as.numeric(h), as.numeric(c), as.numeric(t), PACKAGE = "volfiR")
